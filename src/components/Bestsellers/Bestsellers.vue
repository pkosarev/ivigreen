  ...
  <div class="bestsellers-container">
        ...
        <swiper-slide v-for="(slide, index) in slides" :key="index">
          <div class="bestsellers-card">
            ...
            <div class="text-block">
              <h4 class="text-block--title">{{ slide.title }}</h4>
              <p class="text-block--description">{{ slide.description }}</p>
            </div>
            <Button
              full-width
              size="large"
    ...
    >
      ...
      <svg width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9.14147 0.589897C8.90748 0.716135 8.7616 0.956179 8.7616 1.21726V5.28271H0.734294C0.328964 5.28271 0 5.60404 0 5.99997C0 6.3959 0.328964 6.71724 0.734294 6.71724H8.7616V10.7827C8.7616 11.0447 8.90748 11.2848 9.14147 11.4101C9.37547 11.5372 9.66135 11.5286 9.88752 11.39L17.6573 6.60726C17.8708 6.47528 18 6.24671 18 5.99997C18 5.75324 17.8708 5.52467 17.6573 5.39269L9.88752 0.60998C9.76807 0.537298 9.63198 0.5 9.49589 0.5C9.37449 0.5 9.25211 0.530603 9.14147 0.589897Z" fill="white"/>
      </svg>
    </Button>
  </div>
</template>
...
const handleResize = () => {
  ...
  if (swiper.value) {
    swiper.value.update();
    setTimeout(() => swiper.value?.updateSize(), 100);
  }
};
